...
- **Planos**: `planos.tipo` inclui `cortesia` (`...230000`); `planos.padrao` (índice único parcial, `...210000`) = plano com que empresa nova nasce. Permissões `usuarios/importar` + `usuarios/aprovar_precadastro` (`...160000`, com backfill). Ver `/biz`, `/security`.
