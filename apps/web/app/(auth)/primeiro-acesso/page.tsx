...
export default function PrimeiroAcessoPage() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 w-full max-w-sm px-8 py-10">
      ...
      <h1 className="text-center text-xl font-bold text-gray-800 mb-1">Primeiro acesso</h1>
      <p className="text-center text-sm text-gray-500 mb-6">
        Informe seu CPF e o código recebido por WhatsApp (ou e-mail) para criar sua senha
      </p>
