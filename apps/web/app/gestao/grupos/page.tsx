  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {mock.map(grupo => (
          <Link key={grupo.id} href={`/gestao/grupos/${grupo.id}/subgrupos`} className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-sm transition-shadow block">
