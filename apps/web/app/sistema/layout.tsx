...
import { Building2, MessageCircle, ShieldCheck, Compass, Handshake, Bot, Package, Boxes, LayoutGrid, BookOpen, ListChecks, X, Cpu, Send } from 'lucide-react'
...
const SISTEMA_NAV = [
  ...
  { href: '/sistema/telegram',  label: 'Telegram',     icon: Send },
  { href: '/sistema/integracoes-ia', label: 'IA',      icon: Bot },
  { href: '/sistema/dispositivos', label: 'Dispositivos', icon: Cpu },
